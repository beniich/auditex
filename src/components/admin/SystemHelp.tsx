    ...
    <div className="min-h-screen bg-[#f8fafc] p-10 font-sans cursor-default">
      <div className="max-w-[1440px] mx-auto space-y-12">
        ...
        <div className="grid grid-cols-4 gap-8">
           {[
             { title: 'Compliance Base', icon: <Gavel size={24} />, desc: 'Understanding regulatory frameworks and local law mapping.', color: 'blue' },
             { title: 'Security Protocols', icon: <ShieldCheck size={24} />, desc: 'Deep-dive into the cryptographic event store and vault security.', color: 'emerald' },
             { title: 'Forensic Tools', icon: <Activity size={24} />, desc: 'Documentation for event replay, node analysis, and incident labs.', color: 'amber' },
             { title: 'Platform Admin', icon: <Lock size={24} />, desc: 'Managing RBAC, entities, and global system configurations.', color: 'purple' },
           ].map((cat, i) => (

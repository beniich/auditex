        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-8 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              {[
                { label: 'Total Reports Shared', value: '142', status: 'VERIFIED', icon: <FileCheck size={16} className="text-emerald-500" /> },
                { label: 'Active Inquiries', value: '04', status: 'IN REVIEW', icon: <Activity size={16} className="text-blue-500" /> },
                { label: 'Integrity Score', value: '99.9%', status: '24H SYNC', icon: <Lock size={16} className="text-slate-400" /> },
              ].map((stat, i) => (
